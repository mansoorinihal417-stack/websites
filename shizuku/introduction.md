...
The name Shizuku comes from [a character](httpadb shell sh /storage/emulated/0/Android/data/moe.shizuku.privileged.api/start.sh
s://danbooru.donmai.us/posts/3553474).
